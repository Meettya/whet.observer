  ...
  module.exports = Observer = (function() {
    ...
    */
    ...
    Observer.prototype.subscribe = function(topics, callback, context) {
      var topic, usedTopics, _base, _i, _len, _ref;
      if (context == null) {
        context = {};
      }
      usedTopics = {};
    ...
    */
    ...
    Observer.prototype.unsubscribe = function(topics, callback, context) {
      var idx, task, topic, usedTopics, _i, _j, _len, _len1, _ref, _ref1, _ref2;
      usedTopics = {};
      if (topics.topics) {
        _ref = this._unsubscribe_handler_parser(topics, callback, context), topics = _ref[0], callback = _ref[1], context = _ref[2];
      }
      context || (context = {});
    ...
    */
    ...
    Observer.prototype.publish = function() {
      var data, task, topic, topics, _i, _j, _len, _len1, _ref, _ref1;
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        if (topic !== '' && this._subscriptions[topic]) {
          _ref1 = this._subscriptions[topic];
